          ...
          <div className="mt-16 relative">
            ...
            <div className="bg-[#F9F8F3] mt-10 py-8 px-6 md:pl-12 pr-6">
              {[
                ...
                <p
                  className="border-b py-1 border-[#EBE9E0] text-[#0D0106] capitalize text-xs"
                  key={item}
                >
                  {item}
                </p>
            ...
            <div className="lg:absolute lg:right-10 lg:top-0">
              <div className="mt-5 lg:mt-0 grid grid-cols-2  md:grid-cols-3 gap-2 px-4 lg:px-0">
                {subscriptionPlans.map((plan) => (
                  <div
                    key={plan.name}
                    className={`border relative h-[580px] rounded-md p-4 bg-[#FFFFFF8F] flex flex-col justify-between gap-3 items-center  border-[#EBE9E0] ${
                    ...
                    <div className="mt-2 lg:mt-4">
                      <ul className="list-inside list-disc">
                        {Object.entries(plan.features).map(([key, value]) => (
                          <li
                            key={key}
                            className="text-center lg:border-b-0 border-b broder-[#EBE9E0]"
                          >
                      ...
                      <div className="mt-14 flex justify-center items-center">
                        <Button
                          label="Select"
                          className="py-2  text-xs uppercase text-[#0D0106] bg-white border border-[#0D0106]"
                        />
                      </div>
                    </div>
                  </div>
